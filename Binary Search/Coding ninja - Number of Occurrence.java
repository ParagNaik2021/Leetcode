**********************************Binary Search - Number of Occurrence*****************************************
...
public class Solution {
    ...
    public static int counter(int[] arr,int n,int x){
        int[] ans=firstAndLastPosition(arr,n,x);
        if(ans[0]==-1) return 0;
        return (ans[1]-ans[0]+1); //this will store index of first and last
    }
    public static int count(int arr[], int n, int x) {
        //Your code goes here
        int ans=counter(arr,n,x);
        return ans;
